#!/usr/bin/env python3
"""
MTS Service API 测试脚本 (修复版)

该脚本用于测试 mts-service 的所有 API 端点。
注意：所有数字字段（odds, amount）都使用字符串格式。
"""
...
class MTSAPITester:
    ...
    def test_single_bet_success(self):
        ...
        self.record_result("TC-SINGLE-001", "成功提交单注", result, "200 OK, accepted")
    ...
    def test_single_bet_invalid_odds(self):
        ...
        result = self.make_request("POST", "/api/bets/single", data)
        self.record_result("TC-SINGLE-003", "无效的赔率", result, "400 Bad Request")
    ...
    def test_accumulator_success(self):
        ...
        self.record_result("TC-ACC-001", "成功提交串关", result, "200 OK, accepted")
    ...
    def test_system_bet_success(self):
        ...
        self.record_result("TC-SYS-001", "成功提交系统投注", result, "200 OK, accepted")
    ...
    def test_banker_system_success(self):
        ...
        self.record_result("TC-BANKER-001", "成功提交 Banker 系统投注", result, "200 OK, accepted")
    ...
    def test_preset_trixie_success(self):
        ...
        self.record_result("TC-PRESET-001", "成功提交 Trixie 投注", result, "200 OK, accepted")
    ...
    def test_multi_bet_success(self):
        ...
        self.record_result("TC-MULTI-001", "成功提交多重彩", result, "200 OK, accepted")
