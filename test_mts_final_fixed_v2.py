#!/usr/bin/env python3
"""
MTS Service API 最终测试脚本 (修复 Banker 投注 v2)
"""
...
class MTSFinalTester:
    ...
    def test_banker_system_success_final(self):
        ...
        outer_size = [len(bankers) + s for s in size]
        
        root_system = {
            "type": "system",
            "size": outer_size,
            "selections": [banker_system, main_system]
        }
    ...
    def run_all_tests(self):
        """运行所有测试"""
        self.log("=" * 60, "INFO")
        self.log("开始 MTS API 最终测试 (修复 Banker v2)", "INFO")
    ...
    def generate_report(self, output_file: str = "final_test_results_fixed_v2.json"):
        """生成测试报告"""
